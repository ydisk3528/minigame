...
SOURCE = PROJECT.parent / 'coderesoures/assets'
...
def main():
        ...
        for packid,ids in cfg['packs'].items():
            ...
            for i,entry in enumerate(data[5]):
                ...
                if isinstance(first,dict) and 'rect' in first and 'name' in first:
                    ...
                    imageuid=str(uuid.uuid5(uuid.NAMESPACE_URL,'teenpatti/sprite/'+uid))
    ...
    def convert(v):
        ...
        return out
    lang=json.loads((PROJECT.parent/'coderesoures/lang-en-us.json').read_bytes())
    common=json.loads((PROJECT.parent/'coderesoures/lang-common-en-us.json').read_bytes())
