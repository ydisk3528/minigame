...
if __name__=='__main__':
    print('http://127.0.0.1:18037/ (table hold controlled by temp/hold-table.flag)',flush=True)
    ThreadingHTTPServer(('127.0.0.1',18037),partial(Handler,directory=str(ROOT/'build/web-mobile'))).serve_forever()
