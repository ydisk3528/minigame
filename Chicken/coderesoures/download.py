...
BASE='https://casino-wbgame.jiligames.com/chickendash10000/'
...
def main():
    paths=['index.html','index.8c283.js','application.23f3e.js','src/system.bundle.543e6.js','src/import-map.66dfc.json','src/settings.abcad.json','cocos-js/cc.34338.js','src/chunks/bundle.b1c26.js','src/annin-framework/utils/fflate.min.5fd4f.js']
    batch(paths)
    settings=json.loads((ROOT/'src/settings.abcad.json').read_bytes());configs={};imports=[]
